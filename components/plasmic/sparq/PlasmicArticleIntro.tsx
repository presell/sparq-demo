...
import sty from "./PlasmicArticleIntro.module.css"; // plasmic-import: 4w-gEvjCCP/css
  ...
  return (
    ...
    >
      ...
      {true ? (
        ...
        >
          <div className={classNames(projectcss.all, sty.column__sxqxN)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__rVrTq)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
